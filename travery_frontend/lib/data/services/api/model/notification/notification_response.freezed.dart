...
mixin _$NotificationResponse {
 ...
 NotificationPageResponse get notifications; int get unreadCount;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotificationResponse&&(identical(other.notifications, notifications) || other.notifications == notifications)&&(identical(other.unreadCount, unreadCount) || other.unreadCount == unreadCount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,notifications,unreadCount);
...
@useResult
$Res call({
 NotificationPageResponse notifications, int unreadCount
});


$NotificationPageResponseCopyWith<$Res> get notifications;
...
as NotificationPageResponse,unreadCount: null == unreadCount ? _self.unreadCount : unreadCount // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
/// Create a copy of NotificationResponse
...
$NotificationPageResponseCopyWith<$Res> get notifications {
  ...
  return $NotificationPageResponseCopyWith<$Res>(_self.notifications, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( NotificationPageResponse notifications,  int unreadCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( NotificationPageResponse notifications,  int unreadCount)  $default,) {final _that = this;
switch (_that) {
case _NotificationResponse():
return $default(_that.notifications,_that.unreadCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( NotificationPageResponse notifications,  int unreadCount)?  $default,) {final _that = this;
switch (_that) {
case _NotificationResponse() when $default != null:
return $default(_that.notifications,_that.unreadCount);case _:
  return null;
...
class _NotificationResponse implements NotificationResponse {
  const _NotificationResponse({required this.notifications, this.unreadCount = 0});
  factory _NotificationResponse.fromJson(Map<String, dynamic> json) => _$NotificationResponseFromJson(json);

@override final  NotificationPageResponse notifications;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NotificationResponse&&(identical(other.notifications, notifications) || other.notifications == notifications)&&(identical(other.unreadCount, unreadCount) || other.unreadCount == unreadCount));
}
...
@override $NotificationPageResponseCopyWith<$Res> get notifications;
