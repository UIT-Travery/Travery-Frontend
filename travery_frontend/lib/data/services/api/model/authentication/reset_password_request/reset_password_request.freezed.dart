...
mixin _$ResetPasswordRequest {
 ...
 String get email; String get newPassword; String get confirmPassword; String get otp;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,email,newPassword,confirmPassword,otp);

@override
String toString() {
  return 'ResetPasswordRequest(email: $email, newPassword: $newPassword, confirmPassword: $confirmPassword, otp: $otp)';
}
...
@useResult
$Res call({
 String email, String newPassword, String confirmPassword, String otp
});
...
/// Create a copy of ResetPasswordRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? newPassword = null,Object? confirmPassword = null,Object? otp = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email,  String newPassword,  String confirmPassword,  String otp)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ResetPasswordRequest() when $default != null:
return $default(_that.email,_that.newPassword,_that.confirmPassword,_that.otp);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email,  String newPassword,  String confirmPassword,  String otp)  $default,) {final _that = this;
switch (_that) {
case _ResetPasswordRequest():
return $default(_that.email,_that.newPassword,_that.confirmPassword,_that.otp);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email,  String newPassword,  String confirmPassword,  String otp)?  $default,) {final _that = this;
switch (_that) {
case _ResetPasswordRequest() when $default != null:
return $default(_that.email,_that.newPassword,_that.confirmPassword,_that.otp);case _:
  return null;
...
class _ResetPasswordRequest implements ResetPasswordRequest {
  const _ResetPasswordRequest({required this.email, required this.newPassword, required this.confirmPassword, required this.otp});
...
/// Create a copy of ResetPasswordRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? newPassword = null,Object? confirmPassword = null,Object? otp = null,}) {
