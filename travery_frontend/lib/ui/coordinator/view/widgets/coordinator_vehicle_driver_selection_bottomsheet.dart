...
class CoordinatorVehicleDriverSelectionBottomSheet extends StatefulWidget {
  const CoordinatorVehicleDriverSelectionBottomSheet({super.key});
  ...
  static Future<void> show(BuildContext context) {
    return showModalBottomSheet(
      ...
      builder: (context) => const CoordinatorVehicleDriverSelectionBottomSheet(),
    );
  }

  @override
  State<CoordinatorVehicleDriverSelectionBottomSheet> createState() =>
      _CoordinatorVehicleDriverSelectionBottomSheetState();
}

class _CoordinatorVehicleDriverSelectionBottomSheetState
    extends State<CoordinatorVehicleDriverSelectionBottomSheet> {
  int _currentStep = 0; // 0: Xe, 1: Tài xế
